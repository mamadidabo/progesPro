...
function updateLaTeX(schemeExpression,id,langue)
{
	compteurscheme(langue);
...
function compteurscheme(langue) {
	...
	{                      
		...
		if(parenthese != 0){
			if(parenthese > 0){
				...
				if ( langue == "en")
				{
					afficheErreur(parenthese+" missing open parenthesis  to the line "+i+" ! <br>");
				}else{
					afficheErreur("Il manque "+parenthese+" parenth&egravese(s) fermante(s) &agrave la ligne "+i+" ! <br>");
				}
			}else{
				parenthese = Math.abs(parenthese);
				if ( langue == "en")
				{
					afficheErreur(parenthese+" missing close parenthesis  to the line "+i+" ! <br>");
				}else{
					afficheErreur("Il manque "+parenthese+" parenth&egravese(s) ouvrante(s) &agrave la ligne "+i+" ! <br>");
				}
			}
			parenthese =0;
		}
