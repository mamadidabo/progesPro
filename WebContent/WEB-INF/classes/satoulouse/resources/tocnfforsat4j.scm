;Ce fichier permet de transformer une formule propositionnelle en CNF.
;Cette opération nécessite des variables propositionnelles supplémentaires.


;numéro d'une variable propositionnelle supplémentaire
(define temppropnumber 0)

;donne une nouvelle variable propositionnelle supplémentaire jamais utilisée
...
;(cnfsub '(p and q))
  ...
  ;renvoie vrai ssi phi est une clause
  ...
  ; transforme une formule phi en CNF.
  ;une CNF est représentée par une liste de liste de propositions.  
  ;(formulatocnf 'p)
